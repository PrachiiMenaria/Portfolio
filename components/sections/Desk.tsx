      ...
      <div className="max-w-4xl mx-auto w-full relative z-10 pl-0 md:pl-10">
        ...
        <div className="grid md:grid-cols-2 gap-12 md:gap-8 items-start max-w-3xl mx-auto relative">
          ...
          <motion.div
            ...
            className="bg-vintage-slate/20 p-8 shadow-paper border border-vintage-slate/30 relative rounded-sm"
          >
            {/* Pin */}
          ...
          <motion.div
            ...
            transition={{ type: "spring", stiffness: 200, damping: 15 }}
            className="bg-vintage-sepia/20 p-8 shadow-md hover:shadow-lg relative overflow-visible flex flex-col min-h-[350px] rounded-sm cursor-pointer border border-vintage-sepia/30 transform rotate-3 w-full"
          >
            {/* Subtle vintage texture */}
